...
class ScriptArgs(U.ExecuteTrainConfig):
    ...
    train_cp: int = 4
    train_etp: int = 1
    # Rollout parallelism: 1 engines × 32 GPUs each (EP=32 for better expert locality)
...
def execute(args: ScriptArgs):
    ...
    if args.multinode:
        ...
        ckpt_args = (
            ...
            f"--ref-load /root/multinode/{MODEL_NAME}_torch_dist_4layers/ "
        )
    else:
